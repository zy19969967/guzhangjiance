...
def get_files(root, dataset, faults, fault_label, signal_size, stride=None):
    data, actual_labels = [], []
...
class dataset(object):
    ...
    def __init__(self, args, dataset, source_idx, balance_data=False, test_size=0.2):
        ...
        self.data, self.actual_labels = get_files(data_root, dataset, faults, fault_label, signal_size, stride=stride)
